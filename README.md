...
- ueberauth
  ...
  - https://github.com/ueberauth/ueberauth_example/tree/master/web/controllers/auth_controller.ex
...
## After the above, ship real release, contiune working on the rest of this list
- excoveralls
- code climate
...
## New work
- mount methods should take in a module that is the "user module",
  allowing multiple user config

- Documentation - oh god the documentation
